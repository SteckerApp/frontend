    ...
    <div class="d-flex flex-column px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap my-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 wpx-260 hpx-165 mbpx-20 rounded-px-20 bg-blue-lt-1 text-black">
                ...
                <div class="gilroy-medium fs-40 text-center mtpx-n5">{{AuthService.userCurrency()}}{{affiliateData.total_payment}}</div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 wpx-260 hpx-165 mbpx-20 rounded-px-20 bg-blue-lt-1 text-black">
                ...
                <div class="gilroy-medium fs-40 text-center mtpx-n5">{{AuthService.userCurrency()}}{{affiliateData.total_paid}}</div>
                <div class="gilroy-regular fs-12 text-center mt-4">Just Updated</div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 wpx-260 hpx-165 mbpx-20 rounded-px-20 bg-blue-lt-1 text-black">
                <div class="gilroy-regular fs-17 text-center mtpx-35">Available for withdrawal</div>
                <div class="gilroy-medium fs-40 text-center mtpx-n5">{{AuthService.userCurrency()}}{{affiliateData.pending_payment}}</div>
                <div class="gilroy-regular fs-12 text-center mt-4">Just Updated</div>
            </div>
        </div>
        <div class="referrer d-flex flex-column rounded-bottom-px-20 bg-white w-100 mt-2">
            <div class="d-flex flex-column referrer-head w-100 pxpx-60 py-4 text-white">
                <div class="d-flex">
                    ...
                    <span class="gilroy-bold fs-45 my-auto wpx-204 hpx-63 bg-yellow text-center ms-5 text-blue-dk-2 rounded-px-10">{{AuthService.userCurrency()}}5,000</span>
                </div>
                <span class="gilroy-regular mt-n2 header-text">Refer Spark to friends and families & earn N5,000 everytime they use our services</span>
            </div>
