<template>
  ...
  <div 
    class="plans mx-auto d-flex flex-wrap justify-content-center position-absolute"
    :style="usedInModal ? 'top:140px' : 'top:520px'"
  >
      ...
      <div class="plan-items mt-4">
        ...
        <div class="d-flex flex-column mt-auto">
          ...
          <router-link
              v-if="isNonAuth"
              to="/register" 
              class="non-auth-select-plan perfect-center text-decoration-none fs-15 lh-19 gilroy-bold wpx-200 hpx-42 px-3 rounded-px-8 mt-2"
          >Select plan
          </router-link>
          <FormButton v-else label="Select plan" variant="light" class="mt-2 hpx-42"/>
        </div>
    </div>
