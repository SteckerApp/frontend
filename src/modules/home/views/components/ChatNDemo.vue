    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="item-left d-flex col-12 col-lg-6 pypx-100 bg-blue">
                <div class="content d-flex flex-column my-auto">
                    <i class="material-icons-outlined text-white fs-100">forum</i>
            ...
            <div class="item-right d-flex col-12 col-lg-6 pypx-100 bg-blue-lt-1">
                <div class="content d-flex flex-column my-auto">
                    <i class="material-icons-outlined text-blue-dk-2 fs-100">smart_display</i>
