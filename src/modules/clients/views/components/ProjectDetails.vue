                            ...
                            <div class="d-flex flex-column px-5 py-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex gilroy-medium fs-18 lh-21 my-auto ms-5">
                                        <span class="my-auto me-3">Progress:</span>
                            ...
                            <div class="chat-area d-flex flex-column mt-auto px-5 py-3">
                                <div class="chat-messages hpx-450 overflow-auto mb-2">
                                    ...
                                    <div class="d-flex mb-4" v-for="(chat, i) in chats" :key="i">
                                        <UserAvatar 
                                            class="mb-auto"
                                            :class="{'order-2': !chat.is_client}"
                                            size="30" 
                                            :src="chat.user.avatar"
                                        />
                                        <div class="my-auto d-flex flex-column" :class="!chat.is_client ? ' me-3 order-1 align-items-end' : 'ms-3'">
                                            <div class="d-flex mb-2">
                                                <span class="my-auto gilroy-medium fs-15 lh-18 me-2">{{chat.user.first_name}} {{chat.user.last_name}}</span>
                                                <span class="my-auto text-white bg-blue rounded-px-4 hpx-17 px-3 perfect-center gilroy-regular fs-10 lh-12" v-if="i==0">Author</span>
                                            </div>
                                            <div class="chat-message d-flex flex-column rounded-px-10 w-60 p-2 mb-1">
                                                <span class="gilroy-regular fs-12 lh-20">
                                                    {{chat.message}}
                                                </span> 
                                                <div class="d-flex mt-2 cursor-pointer" v-if="chat.file">
                                                    <img :src="require(`@/assets/img/file-formats/${chat?.file?.split('.')?.pop() || 'png'}.svg`)" class="me-1 my-auto wpx-13"/>
                                                    <span class="text-blue gilroy-medium fs-10 lh-12 my-auto">{{chat.file}}</span>
                                                </div>
                                            </div>
...
const chats = ref([
        ...
        },
        {
            ...
            file: 'path/to/file_to_download.pdf',
